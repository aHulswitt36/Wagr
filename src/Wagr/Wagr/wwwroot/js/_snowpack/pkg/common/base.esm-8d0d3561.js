...
var require$$0 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(_polyfillNode_events);
...
var require$$0$1 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(nodeCrypto);
...
const { Transform: Transform$1 } = readableBrowser;
...
const { Transform: Transform$2 } = readableBrowser;
...
var eos$2 = function(stream, opts, callback) {
	...
	callback = once_1(callback || noop$3);
...
var isFS = function (stream) {
  ...
  if (!require$$0$1) return false // browser
  return (stream instanceof (require$$0$1.ReadStream || noop$4) || stream instanceof (require$$0$1.WriteStream || noop$4)) && isFn(stream.close)
};
...
var destroyer$1 = function (stream, reading, writing, callback) {
  ...
  endOfStream$1(stream, {readable: reading, writable: writing}, function (err) {
    if (err) return callback(err)
    closed = true;
    callback();
  });
  ...
  return function (err) {
    ...
    if (isRequest$3(stream)) return stream.abort() // request.destroy just do .end - .abort is what we want
...
var SOLANA_ADAPTERS = _objectSpread$1$1({
...
var EVM_ADAPTERS = _objectSpread$1$1({
  TORUS_EVM: "torus-evm",
  METAMASK: "metamask",
  COINBASE: "coinbase"
}, MULTI_CHAIN_ADAPTERS);
var WALLET_ADAPTERS = _objectSpread$1$1(_objectSpread$1$1({}, EVM_ADAPTERS), SOLANA_ADAPTERS);
...
var signChallenge = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(payload, chainNamespace) {
...
var verifySignedChallenge = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(chainNamespace, signedMessage, challenge, issuer, sessionTime, clientId) {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            log$1.error("Failed to authenticate user, ,message verification failed", idTokenRes.error);
...
export { safeBuffer as $, ADAPTER_NAMESPACES as A, BaseAdapter as B, CHAIN_NAMESPACES as C, keccak$2 as D, base64url$1 as E, jsonToBase64 as F, getRpcPromiseCallback as G, setupMultiplex as H, createStreamMiddleware as I, pump_1 as J, JRPCEngine as K, createIdRemapMiddleware as L, getPrototypeOf as M, getDefaultExportFromCjs as N, buffer as O, PostMessageStream as P, isBuffer as Q, global$1 as R, SafeEventEmitter as S, browser$2 as T, js as U, dist as V, WALLET_ADAPTERS as W, createAsyncMiddleware as X, createScaffoldMiddleware as Y, process as Z, _inherits as _, _getPrototypeOf as a, readableBrowser as a0, EventEmitter as a1, nextTick as a2, storageAvailable as a3, SOLANA_ADAPTERS as a4, EVM_ADAPTERS as a5, nodeCrypto as a6, classCallCheck as a7, createClass as a8, inherits as a9, possibleConstructorReturn as aa, asyncToGenerator as ab, _typeof_1 as ac, isHexStrict as ad, mergeMiddleware as ae, commonjsRequire as af, require$$0 as ag, _typeof as ah, browser$1 as ai, ObjectMultiplex as aj, BasePostMessageStream as ak, setAPIKey as al, Web3AuthError as am, saveToken as an, verifySignedChallenge as ao, signChallenge as ap, getSavedToken as aq, checkIfTokenIsExpired as ar, clearToken as as, _possibleConstructorReturn as b, _classCallCheck as c, _defineProperty as d, _assertThisInitialized as e, ADAPTER_CATEGORY as f, ADAPTER_STATUS as g, getChainConfig as h, WalletInitializationError as i, _createClass as j, _asyncToGenerator as k, log$1 as l, ADAPTER_EVENTS as m, WalletLoginError as n, lodash_merge as o, createCommonjsModule as p, require$$0$1 as q, regenerator as r, commonjsGlobal as s, inherits_browser as t, getDefaultExportFromNamespaceIfNotNamed as u, Buffer as v, loglevel as w, safeatob as x, get as y, randomId as z };
