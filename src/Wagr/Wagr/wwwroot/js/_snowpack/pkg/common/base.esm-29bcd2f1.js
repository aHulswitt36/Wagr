...
var streamBrowser = events_1.EventEmitter;
...
var require$$0 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(nodeCrypto);
...
if (require$$0 && require$$0.debuglog) {
  debug = require$$0.debuglog('stream');
} else {
...
var streamBrowser$1 = events_1.EventEmitter;
...
function _isUint8Array$2(obj) {
  return Buffer$6.isBuffer(obj) || obj instanceof OurUint8Array$2;
}
...
inherits_browser(Writable$1, streamBrowser$1);
...
inherits_browser(Duplex$4, _stream_readable$1);
...
var EE$1 = events_1.EventEmitter;
...
inherits_browser(Readable$1, streamBrowser$1);
...
inherits_browser(Transform$1, _stream_duplex$1);
...
inherits_browser(PassThrough$1, _stream_transform$1);
...
const { Transform: Transform$2 } = readableBrowser$1;

var keccak = (KeccakState) => class Keccak extends Transform$2 {
...
const { Transform: Transform$3 } = readableBrowser$1;
...
const randomId = () => browser$2(32).toString("hex");

const base64url$1 = base64url;
function safeatob(str) {
  // Going backwards: from bytestream, to percent-encoding, to original string.
  return base64url$1.decode(str);
}
const keccak$2 = js;
function jsonToBase64(json) {
  return base64url$1.encode(JSON.stringify(json));
}
...
function getEthJsonRpcError(code, arg) {
    ...
    return new classes.EthereumRpcError(code, message || utils.getMessageFromCode(code), data);
}
function getEthProviderError(code, arg) {
    const [message, data] = parseOpts(arg);
    return new classes.EthereumProviderError(code, message || utils.getMessageFromCode(code), data);
}
...
Object.defineProperty(exports, "serializeError", { enumerable: true, get: function () { return utils.serializeError; } });
Object.defineProperty(exports, "getMessageFromCode", { enumerable: true, get: function () { return utils.getMessageFromCode; } });

Object.defineProperty(exports, "ethErrors", { enumerable: true, get: function () { return errors.ethErrors; } });
...
var isRequest$4 = function(stream) {
	return stream.setHeader && typeof stream.abort === 'function';
};
...
var eos$4 = function(stream, opts, callback) {
	...
	callback = once_1(callback || noop$5);
...
var isFS = function (stream) {
  ...
  if (!require$$0) return false // browser
  return (stream instanceof (require$$0.ReadStream || noop$6) || stream instanceof (require$$0.WriteStream || noop$6)) && isFn(stream.close)
};

var isRequest$5 = function (stream) {
  return stream.setHeader && isFn(stream.abort)
};

var destroyer$2 = function (stream, reading, writing, callback) {
  ...
  endOfStream$2(stream, {readable: reading, writable: writing}, function (err) {
    if (err) return callback(err)
    closed = true;
    callback();
  });
  ...
  return function (err) {
    ...
    if (isFS(stream)) return stream.close(noop$6) // use close for fs streams to avoid fd leaks
    if (isRequest$5(stream)) return stream.abort() // request.destroy just do .end - .abort is what we want
...
var pipe$2 = function (from, to) {
  return from.pipe(to)
};

var pump = function () {
  var streams = Array.prototype.slice.call(arguments);
  var callback = isFn(streams[streams.length - 1] || noop$6) && streams.pop() || noop$6;
  ...
  var destroys = streams.map(function (stream, i) {
    var reading = i < streams.length - 1;
    var writing = i > 0;
    return destroyer$2(stream, reading, writing, function (err) {
      if (!error) error = err;
...
const ACK = "ACK";
const BRK = "BRK";
class BasePostMessageStream extends readableBrowser.Duplex {
  constructor(_ref) {
    let {
      name,
      target,
...
function createStreamMiddleware() {
  ...
  const stream = new readableBrowser.Duplex({
    objectMode: true,
    read: readNoop,
...
class Substream extends readableBrowser.Duplex {
  constructor(_ref) {
    let {
      parent,
      name
...
class ObjectMultiplex extends readableBrowser.Duplex {
  constructor() {
    let opts = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    super(_objectSpread$2(_objectSpread$2({}, opts), {}, {
      objectMode: true
    }));
...
const get = async function (url) {
  ...
  if (customOptions.useAPIKey) {
    defaultOptions.headers = _objectSpread$3(_objectSpread$3({}, defaultOptions.headers), getApiKeyHeaders());
  }

  const options = lodash_merge(defaultOptions, options_, {
    method: "GET"
  });
...
var SOLANA_ADAPTERS = _objectSpread$1$2({
...
var EVM_ADAPTERS = _objectSpread$1$2({
  TORUS_EVM: "torus-evm",
  METAMASK: "metamask",
  COINBASE: "coinbase"
}, MULTI_CHAIN_ADAPTERS);
var WALLET_ADAPTERS = _objectSpread$1$2(_objectSpread$1$2({}, EVM_ADAPTERS), SOLANA_ADAPTERS);
...
var ADAPTER_EVENTS = _objectSpread$4(_objectSpread$4({}, ADAPTER_STATUS), {}, {
...
var BaseAdapter = /*#__PURE__*/function (_SafeEventEmitter) {
  ...
  _createClass(BaseAdapter, [{
    ...
    get: function get() {
      return this.chainConfig ? _objectSpread$4({}, this.chainConfig) : null;
    }
  }, {
    key: "setChainConfig",
    value: function setChainConfig(customChainConfig) {
      ...
      this.chainConfig = _objectSpread$4(_objectSpread$4({}, defaultChainConfig), customChainConfig);
    }
  }, {
...
var log$1 = loglevel.getLogger("web3auth-logger");
...
export { EventEmitter as $, ADAPTER_EVENTS as A, Buffer as B, CHAIN_NAMESPACES as C, jsonToBase64 as D, getRpcPromiseCallback as E, lodash_merge as F, setupMultiplex as G, createStreamMiddleware as H, pump_1 as I, JRPCEngine as J, createIdRemapMiddleware as K, getPrototypeOf as L, getDefaultExportFromCjs as M, buffer_1 as N, process as O, PostMessageStream as P, global$1 as Q, isBuffer as R, SafeEventEmitter as S, browser$2 as T, js as U, events_1 as V, WALLET_ADAPTERS as W, browser$1 as X, string_decoder as Y, safeBuffer as Z, _defineProperty as _, _inherits as a, nextTick as a0, dist as a1, createAsyncMiddleware as a2, createScaffoldMiddleware as a3, ADAPTER_CATEGORY as a4, BaseAdapter as a5, nodeCrypto as a6, classCallCheck as a7, createClass as a8, inherits as a9, possibleConstructorReturn as aa, asyncToGenerator as ab, _typeof_1 as ac, isHexStrict as ad, mergeMiddleware as ae, commonjsRequire as af, _typeof as ag, _getPrototypeOf as b, _possibleConstructorReturn as c, _classCallCheck as d, _assertThisInitialized as e, ADAPTER_STATUS as f, WalletInitializationError as g, getChainConfig as h, _createClass as i, _asyncToGenerator as j, ADAPTER_NAMESPACES as k, log$1 as l, WalletLoginError as m, createCommonjsModule as n, require$$0 as o, commonjsGlobal as p, inherits_browser as q, regenerator as r, storageAvailable as s, getDefaultExportFromNamespaceIfNotNamed as t, loglevel as u, safeatob as v, get as w, randomId as x, keccak$2 as y, base64url$1 as z };
